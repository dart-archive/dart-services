  ...
  group('analysis_server', () {
    ...
    test('simple_quickFix', () {
      return analysisServer
        ...
        expect(results.fixes.first.offset, 24);
        expect(results.fixes.first.length, 1); //we need an insertion

        // We should be getting an insert ; fix
        expect(results.fixes.first.fixes.length, 1);
        CandidateFix fix = results.fixes.first.fixes[0];
