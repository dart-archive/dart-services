...
import 'analysis_server_null_safety_test.dart'
    as analysis_server_null_safety_test;
...
import 'compiler_null_safety_test.dart' as compiler_null_safety_test;
import 'compiler_test.dart' as compiler_test;
import 'flutter_analysis_server_null_safety_test.dart'
    as flutter_analysis_server_null_safety_test;
import 'flutter_analysis_server_test.dart' as flutter_analysis_server_test;
import 'flutter_web_null_safety_test.dart' as flutter_web_null_safety_test;
...
void main() async {
  analysis_server_null_safety_test.defineTests();
  ...
  compiler_null_safety_test.defineTests();
  compiler_test.defineTests();
  flutter_analysis_server_null_safety_test.defineTests();
  flutter_analysis_server_test.defineTests();
  flutter_web_null_safety_test.defineTests();
