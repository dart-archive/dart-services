...
RUN sudo apt-get update && \
    wget https://storage.googleapis.com/dart-archive/channels/beta/release/2.10.0-110.3.beta/linux_packages/dart_2.10.0-110.3.beta-1_amd64.deb && \
    sudo dpkg -i dart_2.10.0-110.3.beta-1_amd64.deb && \
