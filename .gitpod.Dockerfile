...
RUN sudo apt-get update && \
    wget https://storage.googleapis.com/dart-archive/channels/beta/release/2.11.0-213.1.beta/linux_packages/dart_2.11.0-213.1.beta-1_amd64.deb && \
    sudo dpkg -i dart_2.11.0-213.1.beta-1_amd64.deb && \
