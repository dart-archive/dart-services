...
void main(List<String> args) async {
  ...
  final FlutterWebManager flutterWebManager = FlutterWebManager(SdkManager.flutterSdk);
  await flutterWebManager.initFlutterWeb();

  var compiler = Compiler(SdkManager.sdk, SdkManager.flutterSdk, flutterWebManager);
